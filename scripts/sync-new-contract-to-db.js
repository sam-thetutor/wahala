...
const PREDICTION_MARKET_CLAIMS_ADDRESS = '0x1e1ac759e75dA03a39f16ae72B73279A1edf63d6'
...
// Contract ABI for PredictionMarketCore
...
async function syncNewContractToDatabase() {
  console.log('🚀 Starting sync from new contract to database...')
  console.log('📋 Contract Addresses:')
  console.log('   Core:', PREDICTION_MARKET_CORE_ADDRESS)
  console.log('   Claims:', PREDICTION_MARKET_CLAIMS_ADDRESS)
